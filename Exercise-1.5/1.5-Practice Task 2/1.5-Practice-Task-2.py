# Define __sub__() for heights in feet and inches.

# Subtract 3 feet 9 inches from 5 feet 10 inches.
...
height_sum = person_B_height - person_A_height

print("Total height:", height_sum)

# Output: 

# Total height: 2 feet, 1 inches